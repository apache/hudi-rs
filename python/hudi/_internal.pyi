...
class HudiTable:
    ...
    def split_file_slices(
        self, n: int, filters: List[str]
    ) -> List[List[HudiFileSlice]]: ...
    def get_file_slices(self, filters: List[str]) -> List[HudiFileSlice]: ...
    def read_file_slice(self, base_file_relative_path: str) -> pyarrow.RecordBatch: ...
    def read_snapshot(self, filters: List[str]) -> List["pyarrow.RecordBatch"]: ...

...
-- Table version 6. Partition paths: ts_str=2024/03/01/08 — one hive prefix on the whole
-- formatted value, then nested directories for the slashes in output.dateformat.

CREATE TABLE v6_timebasedkeygen_hivestyle_hour (
    id INT, name STRING, region STRING, amount DOUBLE, ts_str STRING
) USING HUDI
LOCATION 'file:///tmp/v6_timebasedkeygen_hivestyle_hour'
TBLPROPERTIES (
    type = 'cow',
    primaryKey = 'id',
...
INSERT INTO v6_timebasedkeygen_hivestyle_hour VALUES
  (1,'Alice','eu',10.0,'2024-03-01T08:00:00.000Z'),
  (2,'Bob','us',20.0,'2024-03-01T22:30:00.000Z'),
  (3,'Carol','eu',30.0,'2024-03-01T23:15:00.000Z'),
  (4,'Dave','us',40.0,'2024-03-02T00:05:00.000Z'),
  (5,'Eve','eu',50.0,'2024-03-02T01:45:00.000Z');

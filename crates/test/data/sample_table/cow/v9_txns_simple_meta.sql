...
CREATE TABLE v9_txns_cow_simple_meta
(
    txn_id           STRING,
    account_id       STRING,
    txn_ts           BIGINT,
...
-- ============================================================================
INSERT INTO v9_txns_cow_simple_meta VALUES
...
-- ============================================================================
UPDATE v9_txns_cow_simple_meta
...
-- ============================================================================
DELETE FROM v9_txns_cow_simple_meta WHERE txn_id = 'TXN-002';
...
-- ============================================================================
DELETE FROM v9_txns_cow_simple_meta WHERE txn_id = 'TXN-005';
...
-- ============================================================================
INSERT OVERWRITE v9_txns_cow_simple_meta PARTITION (region = 'eu')
...
-- ============================================================================
CALL run_clustering(table => 'v9_txns_cow_simple_meta');
...
CREATE INDEX merchant_idx ON v9_txns_cow_simple_meta (merchant_name);

CREATE INDEX txn_date_idx ON v9_txns_cow_simple_meta (txn_date);
